export const optionLimits={
    ...
    torus:[
        ...
        {name: 'PolygonsR', min: 2, max:128, step:1, slider:true},
        {name: 'PolygonsT', min: 1, max:128, step:1, slider:true},
    ...
    torusKnot:[
        ...
        {name: 'PolygonsT', min: 2, max:128, step:1, slider:true},
        {name: 'PolygonsR', min: 3, max:128, step:1, slider:true},
